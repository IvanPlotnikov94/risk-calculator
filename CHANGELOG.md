...
### Changed
- Сводка по позиции считается только по заполненным точкам входа. При добавлении новой (ещё не заполненной) точки входа сводка продолжает показывать данные по уже заполненным входам и не обнуляется.
