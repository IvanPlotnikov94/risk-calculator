...
- ✅ **Magic-кнопка "Рассчитать позицию"** - авторасчет входов/выходов по заданному риску
...
- Настраиваемые пресеты (сохраняются в браузере между сессиями)
- Модальное окно авторасчета с сохранением черновика параметров
